...
const RESUME = {
  ...
  summary: [
    "I build and secure cloud infrastructure that stays reliable at scale. Over 13+ years I've grown from backend engineer to DevOps/SRE tech lead, leading the teams and platforms behind products serving 1M+ daily users and 2M+ requests per minute.",
  ...
  experience: [
    {
      ...
      bullets: [
        "Architected and operated secure multi-cloud environments (AWS & Azure) with Terraform, enforcing a strict security posture across mission-critical custody.",
        "Integrated Intel SGX for hardware-backed cryptographic protection and trusted execution.",
        "Led infrastructure hardening, privileged access control, secure CI/CD, and secret management.",
        "Drove vulnerability remediation and resilient blockchain node operations across multiple protocols — supporting high-assurance custody and regulatory compliance."
      ]
    },
    {
      company: "XREX Inc.",
    ...
    },
    {
      ...
      projects: [
        ...
        },
        {
          ...
          bullets: [
            "Drove solutions across system bottlenecks, product features, and monetization for one of the world's long-running top-ranked mobile games (2M+ RPM, 1M+ DAU).",
